...
export default function TaskEditModal() {
  ...
  return (
    <div
      ...
      className={`fixed inset-0 bg-black/75 backdrop-blur-[2px] z-50 flex flex-col justify-center items-center gap-4 transition-opacity duration-200 ${
    ...
    >
      ...
      <div className="w-[440px] bg-(--color-11) border border-(--color-8)/30 rounded-xl p-4 flex flex-col gap-3">
        <div>
